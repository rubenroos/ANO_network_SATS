...
Next, we can ask which habitat patches (nature types would we prioritize for its conservation value. For this we can calculate its strength (Bascopmte et al 2006).

```{r}
Cons.val <- df %>% 
  distinct(Nature_type)
...
#check many more parameters
specieslevel(ntw.ANO, level = "both")
