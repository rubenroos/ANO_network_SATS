...
ntw.ext.lower <- second.extinct(web = ntw.ANO, nrep = 100, participant = "lower", method = "abundance", details = FALSE) #random removal of nature types
...
slope.bipartite(ntw.ext.lower, plot.it = TRUE)
```
