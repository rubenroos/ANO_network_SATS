...
#calculate species cover per naturype per flate (using sum)
ANO.cover <- ANO.fjell %>% 
  ...
  rename(Habitat_type = kartleggingsenhet_1m2, 
         Species_cover = cover_sum, 
         Patch = ano_flate_id)#more user-friendly colnames

#Convert to wide format
ANO.cover <- ANO.cover %>% pivot_wider(names_from = Species, values_from = Species_cover, values_fill = 0)
