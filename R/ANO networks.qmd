...
#Installs the github version of bipartite, https://github.com/biometry/bipartite/issues/17
#library(devtools)
...
ANO.fjell <- read_csv("~/Projects/ANO SATS/ANO_network_SATS/Data/ANO.data.fjell.csv", show_col_types = FALSE)#silence warning about missing colnames

names(ANO.fjell)
unique(ANO.fjell$ano_flate_id)
```
